...
final class YamlSuQLTest extends TestCase
{
    public function testYamlSuQLParse(): void
    {
        ...
        $actual = SuQL1::query('tests/suql/yaml/Query1.yaml', Yaml::class)->getRawSql();
    ...
    public function testYamlSuQLAfterParsing(): void
    {
        ...
        $actual = SuQL1::query('tests/suql/yaml/Query2.yaml', Yaml::class)->order(['f2' => 'asc'])->getRawSql();
        $this->assertEquals($expected, $actual);
    }
    ...
    public function testYamlSuQLJoin(): void
    {
        ...
        $actual = SuQL1::query('tests/suql/yaml/Query3.yaml', Yaml::class)->getRawSql();
        $this->assertEquals($expected, $actual);
    }
    ...
    public function testJoinWithYaml(): void
    {
        ...
        $actual1 = Query1::all()->join(SuQL1::query('tests/suql/yaml/Query5.yaml', Yaml::class))->getRawSql();
    ...
    public function testJoinYamlWithYaml(): void
    {
        ...
        $actual1 = SuQL1::query('tests/suql/yaml/Query6.yaml', Yaml::class)->join(SuQL1::query('tests/suql/yaml/Query5.yaml', Yaml::class))->getRawSql();
        $this->assertEquals($expected, $actual1);
    }
}
